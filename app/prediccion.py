...
model_path = os.path.join(os.path.dirname(__file__), '..', 'models', 'ingredientes_model (1).pt')
...
def procesar_imagen(image_path):
    ...
    try:
        ...
        new_results = model.predict(image_path, conf=0.9)
...
# Comentado temporalmente el uso de Ollama
...
def combined_predict(image_path):
    ...
    llama3_text = 'No data available'  # Valor por defecto cuando Ollama está desactivado
